...
<body>
    <div class="form">
        <form method="POST" action="sikayetekle-do.php">
            <div class="mb-3 mt-5">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control formheight" id="sikayetaciklama" name="explain" placeholder="Şikayetinizi Açıklayın" required>
            </div>
            <button type="submit" class="btn btn-primary" name="send">şikayet et</button>
        </form>
    </div>
